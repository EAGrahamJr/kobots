 ...
 * desired rotation. Note that the stepper will only move one step at a time, so the accuracy of the movement is
 * dependent on rounding errors in the calculation of the number of steps required to reach the destination.
 */
 ...
 *
 * TODO map the servo to the actual range of motion - e.g. define the arc and it's relation to the servo's range
 */
