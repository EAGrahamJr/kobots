...
object HAJunk : AppCommon.Startable {
    ...
    private val commandSelectEntity = KobotSelectEntity(Commando, "tower_of_doom", "Tower of Doom", haIdentifier)

    private val rotateThings = mutableListOf<KobotNumberEntity>()
    ...
    fun sendUpdatedStates() {
        ...
        rotateThings.forEach { it.sendCurrentState() }
    }
